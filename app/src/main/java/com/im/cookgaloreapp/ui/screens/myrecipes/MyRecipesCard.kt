...
@Composable
fun MyRecipesCard(recipe: Recipes, context: Context) {
    ...
    Card(
        ...
        Column(
            ...
            val image = recipe.featured_image?.let { imageLoader(url = it, resource = R.drawable.placeholder, context = context).value }
            image?.let {
                Image(
